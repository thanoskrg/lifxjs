...
module.exports = (function () {
  ...
  const Http = (function () {
    ...
    Http.prototype.put = async function (resource, data) {
  ...
  const Lifx = (function () {
    ...
    Lifx.prototype = {
      get lights () {
        if (!_lights) {
          console.warn('Call init({ appToken }) first to get access to your lights.');
          return {
            get () {}
          };
        }
    ...
    // Lifx.prototype.light = function (id) {
    //   return new Light(id);
    // };
